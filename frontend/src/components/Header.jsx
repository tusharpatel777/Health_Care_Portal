...
// //       <Link to="/" className="text-2xl font-bold">HCLTech Healthcare Portal</Link>
// //       <nav>
// //         {userInfo ? (
// //           <div className="flex items-center space-x-4">
// //             <span className="text-lg">Welcome, {userInfo.username}</span>
// //             <button onClick={logoutHandler} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
// //               Logout
// //             </button>
...
// //               <Link to="/provider/dashboard" className="hover:underline">Provider Dashboard</Link>
// //             )}
// //           </div>
// //         ) : (
...
// //             <Link to="/public-info" className="hover:underline">Public Info</Link>
// //           </div>
// //         )}
// //       </nav>
// //     </header>
...
//       className="bg-gradient-to-r from-blue-700 to-blue-500 text-white p-4 shadow-xl flex justify-between items-center z-40 relative" // Added gradient, stronger shadow, z-index
//     >
//       <motion.div variants={logoVariants}>
//         <Link to="/" className="text-3xl font-extrabold tracking-tight"> {/* Increased font size and weight */}
//           Healthcare Portal
//         </Link>
//       </motion.div>
...
//       <nav>
//         {userInfo ? (
//           <div className="flex items-center space-x-6"> {/* Increased space-x for better separation */}
//             <motion.span
//               initial={{ opacity: 0, y: -10 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ delay: 0.6, duration: 0.4 }}
//               className="text-xl font-medium" // Slightly larger and bolder greeting
//             >
//               Welcome, {userInfo.username}
//             </motion.span>
//             <motion.button
//               whileHover={{ scale: 1.1, backgroundColor: '#dc2626', color: '#fff' }} // Enhanced hover for logout
//               whileTap={{ scale: 0.9 }}
//               onClick={logoutHandler}
//               className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-5 rounded-full shadow-md transition-all duration-200 ease-in-out" // Pill shape, better shadow
//             >
//               Logout
//             </motion.button>
//             {userInfo.role === 'patient' && (
...
//                   visible: {
//                     transition: {
//                       delayChildren: 0.8, // Stagger children after initial delay
//                       staggerChildren: 0.1
//                     }
//                   }
//                 }}
...
//                   <Link to="/dashboard" className="hover:text-blue-200 transition-colors duration-200 text-lg font-semibold">Dashboard</Link>
//                 </motion.div>
//                 <motion.div variants={navItemVariants}>
//                   <Link to="/profile" className="hover:text-blue-200 transition-colors duration-200 text-lg font-semibold">Profile</Link>
//                 </motion.div>
//               </motion.div>
//             )}
//             {userInfo.role === 'healthcare_provider' && (
...
//               >
//                 <motion.div variants={navItemVariants}>
//                   <Link to="/provider/dashboard" className="hover:text-blue-200 transition-colors duration-200 text-lg font-semibold">Provider Dashboard</Link>
//                 </motion.div>
//               </motion.div>
//             )}
//           </div>
...
//           >
//             <motion.div variants={navItemVariants}>
//               <Link to="/login" className="hover:text-blue-200 transition-colors duration-200 text-lg font-semibold">Login</Link>
//             </motion.div>
//             <motion.div variants={navItemVariants}>
//               <Link to="/register" className="hover:text-blue-200 transition-colors duration-200 text-lg font-semibold">Register</Link>
//             </motion.div>
//             <motion.div variants={navItemVariants}>
//               <Link to="/public-info" className="hover:text-blue-200 transition-colors duration-200 text-lg font-semibold">Public Info</Link>
//             </motion.div>
//           </motion.div>
//         )}
//       </nav>
